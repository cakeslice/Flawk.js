...
export default function Style(props: Props) {
	...
	const [animationUUID, setAnimationUUID] = useState<undefined | string>(undefined)
	//
	const [buttonAppearance, setButtonAppearance] = useState('default')
	const [usageBackground, setUsageBackground] = useState<undefined | string>(undefined)
						...
						>
							<div style={{ ...styles.card }}>
								...
								<i>
									...
									adipiscing elit, sed do tempor <hl>highlighted</hl> incididunt
									ut <u>underline</u> et dolore magna.
								</i>
								<sp />
								<p>
									<b>
...
`}
							description={
								<>
									In <code>styles.colors</code> you can find the main app colors
									and some basic colors to use in your project.
									<sp />
...
`}
							description={
								<>
									All components in Flawk support a <m>dark</m> and <m>light</m>{' '}
									mode. If <code>global.nightMode</code> is <code>true</code> the
									app is in dark mode.
									<sp />
						...
						<Section
							...
							description={
								<>
									...
									<code>styles.card</code> and <code>styles.outlineCard</code> as
									a base for your own cards.
									<sp />
									The base card styles are however used in some Flawk components
									like <code>{'<Modal/>'}</code>. You can override them in{' '}
							...
							>
								...
								>
									<div>
										...
										<hsp />
										<p style={{ opacity: 0.9 }}>
											Finally, the Best Pancakes Ever. They are fluffy, crispy
											on the edges, tender in the middle, and completely
											stackable. The search is over!
										</p>
									</div>
									<hsp />
						...
						<Section
							description={
								<>
									...
									<br />
									If no <code>src</code> image available, it falls back to name
...
`}
						...
						<Section
							description={
								<>
									Use <code>size</code> prop to set the <m>size</m> of the loading
									animation.
									<sp />
									The component will only be visible after a small delay to{' '}
									<m>avoid flickering</m> in case the respective content loads too
									fast.
									<br />
						...
						<Section
							description={
								<>
									...
									<sp />
									In some cases the tooltip can be <m>hidden</m> behind a modal
									for example and the <code>foreground</code> prop can be used to
									make it visible.
									<br />
									If <m>interaction</m> with the tooltip content is needed like
									buttons or links, the <code>selectable</code> prop can be used
									to make the tooltip content <m>clickable</m>.
									<sp />
...
`}
									...
									content={
										<div>
											<p>
												...
												adipiscing elit, sed do eiusmod tempor <b>bold</b>{' '}
						...
						<Section
							description={
								<>
									Use <code>appearance</code> prop to set the <m>button style</m>.
									You can override or add new button styles in{' '}
									<code>src/project/_styles.ts</code> using the{' '}
									...
									<sp />
									The button component can also be used as a <m>checkbox</m> with
									the <code>checkbox</code> prop which is a string for the
									checkbox label.
								</>
							}
...
`}
						...
						<Section
							description={
								<>
									Use <code>effects</code> prop to set the effects to be applied
									when the component is <m>visible</m>.
									<br />
									Multiple effects can be applied at the <m>same time</m>.
									<sp />
									The <code>duration</code>, <code>delay</code>, and{' '}
									<code>distance</code> props can be used to configure the effects{' '}
									<m>behaviour</m>.
									<sp />
									To control when the animation is <m>triggered</m>, use{' '}
									<code>controlled</code> prop. If set to <m>false</m>, it will{' '}
									<m>revert</m> the animation including visibility for some
									effects like <code>fade</code>.
									<sp />
